...
DEFAULT_MODEL_DIR = 'example_submissions/submission'
...
(52 scenarios, with similar number of timesteps than the private datasets on codalab)
"""
...
def evaluate_submission(model_dir,
    ...
    if(agent_name != ""):
        output_submission_ = os.path.join("utils", agent_name+"_submission_results")
