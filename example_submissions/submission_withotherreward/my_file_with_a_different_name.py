...
class CustomOtherReward(BaseReward):
    """
    if you want to control the reward used by the environment when your agent is being assessed, you need
...
other_rewards = {"my_second_reward": CustomOtherReward, "my_third_reward": L2RPNReward}
